...
<br/>mohankrishnas3 is the username of my github

2. *What is the URL of your remote GitHub repo (created through Mr. Kennedy's exercises)?*
<br />"https://github.com/mohankrishnas3/remoterepo" is the URL of my remote Github
## R
...
<br/> It has 234 rows and 11 columns.
1. (Q4) *Make a scatterplot of hwy vs cyl.*
<br/>Here is the code for it
```{r}
ggplot(data = mpg) + 
